...
import { Job, JobState } from "../../features/jobs/entities/job.entity";
...
} from "../../core/constants/memory-compression.constant";
...
export class MemoryCompressionService {
  ...
  constructor(
    ...
    this.minEmbeddingsThreshold = memoryCompressionCfg.minEmbeddingsThreshold;
    this.preserveRecentCount = memoryCompressionCfg.preserveRecentCount;
    this.activeConversationDays = memoryCompressionCfg.activeConversationDays;
  }
  ...
  async mergeCluster(
    ...
    if (!planId) {
      throw ResourceException.validation(
        "Cannot merge cluster: missing planId",
      );
    }
